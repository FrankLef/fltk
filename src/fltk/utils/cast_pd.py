"""Cast all columns with str datatype to object. Pandas temporary fix."""
import pandas as pd
from typing import Iterable

def cast_pd_dtype(df: pd.Dataframe, from_dtypes:Iterable[str], to_dtype:str)->pd.Dataframe:
    """Cast pandas dtypes to a new dtype.add()
